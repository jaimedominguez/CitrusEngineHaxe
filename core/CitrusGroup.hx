...
/**
	 ...
	 */
class CitrusGroup extends Entity
{
    public var groupObjects(get, never) : Array<CitrusObject>;

    
    private var _groupObjects : Array<CitrusObject> = new Array<CitrusObject>();
    ...
    override public function destroy() : Void {
        as3hx.Compat.setArrayLength(_groupObjects, 0);
    ...
    {
        _groupObjects.splice(Lambda.indexOf(_groupObjects, object), 1);
    ...
    /**
		 ...
		 */
    public function setParamsOnObjects(param : Dynamic) : Void {
        for (object in _groupObjects)
        {
    ...
    /**
		 ...
		 * @param param An object where properties and value are defined.
		 */
    public function setParamsOnViews(param : Dynamic) : Void {
        for (object in _groupObjects)
        {
    ...
    /**
		 ...
		 */
   public function get_groupObjects() : Array<CitrusObject>
    {
