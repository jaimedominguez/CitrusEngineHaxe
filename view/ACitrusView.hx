...
class ACitrusView
{
  ...
  //  public var loadManager : LoadManager;
    ...
    public var _viewObjects : Dictionary<String,StarlingArt> = new Dictionary<String,StarlingArt>();
    private var _root : Dynamic;
    private var _viewInterface : Class<Dynamic>;
    ...
    /**
		 ...
		 */
    public function addArt(citrusObject : CitrusObject) : Void {
        ...
        if (art != null)
        {
		  // trace("ADD ART:" + citrusObject.name);
           _viewObjects[citrusObject.getString()] = art;
    ...
    /**
		 ...
		 * art representation. 
		 */
    public function removeArt(citrusObject : CitrusObject) : Bool	
    {
		...
		destroyArt(citrusObject);
     	_viewObjects.remove(citrusObject.getString());
		return true;
    ...
    /**
		 ...
		 * </p>
		 */
    public function getArt(citrusObject : CitrusObject) : Dynamic
    {
        if (!Std.is(citrusObject, _viewInterface))
        {
        ...
        return _viewObjects[citrusObject.getString()];
    }
    ...
    /**
		 ...
		 * 
		 */
    private function createArt(citrusObject : CitrusObject) : Dynamic
    {
        return null;
    }
    ...
    /**
		 ...
		 */
    private function updateArt(citrusObject : CitrusObject, art : Dynamic) : Void {
		trace("NON UPDATE ART." + citrusObject.name);
    }
    
    /**
		 * A CitrusView subclass will extend this method to destroy the art associated with the provided CitrusObject. 
		 */
    private function destroyArt(citrusObject : CitrusObject) : Void {
		trace("NON DESTROY ART." + citrusObject.name);
    }
}
